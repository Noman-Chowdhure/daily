    ...
    <div className=" w-full h-fit overflow-hidden">
      ...
      <div className="contents ">
        <form
          ...
          className=" grid  w-4/5 mx-auto md:grid-cols-2 grid-cols-1 md:gap-x-4 gap-6"
        >
          ...
          <div className="linuxx w-full grid grid-cols-1 space-y-4">
            ...
            <div className="box w-full grid grid-cols-2 items-center ">
              <button
